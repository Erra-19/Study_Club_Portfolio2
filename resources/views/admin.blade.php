                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Order Search</h6>                                    
                                </div>
                                <!-- Card Body -->
                                <div class="col-12 mb-3">
                                    ...
                                    <form action="{{ route('admin.search') }}" method="GET">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="receipt_number" id="receipt_number" class="form-control" placeholder="Enter the tracking number" required>
